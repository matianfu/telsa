...
/** @function UInt8 - convert uint8 to buffer */
...
@type {function}
@param {CT} type - tls record type
@param {buffer} data - tls record data (payload)
@returns {buffer} encrypted tls record 
*/

/**
This is a (higher-order) factory function to generate a stateful cipher function, 
...
class Established extends State {
  ...
  _write (data, _, callback) {
    this.ctx.socketWrite(CT.APPLICATION_DATA, data, callback)
  }
